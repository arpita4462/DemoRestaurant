package com.gmediasolutions.demorestaurant.alert
...
class CheckPermission{
   ...
   internal fun  ischeckandrequestPermission(appCompatActivity: AppCompatActivity):Boolean {
       ...
       val permissions = arrayOf(Manifest.permission.ACCESS_COARSE_LOCATION,
               ...
               Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_SMS,Manifest.permission.RECEIVE_SMS,
